...
export default function TestimonialCard({ testimonial, index }: TestimonialCardProps) {
    return (
        <motion.div className="p-4 rounded-lg mx-4 w-72 shrink-0 bg-linear-to-br from-red-600 to-slate-800 border border-slate-800"
            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p className="text-slate-300">{testimonial.name}</p>
                    ...
                    <span className="text-xs text-slate-300">{testimonial.handle}</span>
                </div>
            </div>
