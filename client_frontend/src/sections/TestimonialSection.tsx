...
export default function TestimonialSection() {
  return (
    <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        text1="Testimonials"
        text2="Loved by the creators"
        text3="See how our AI thumbnils sre helping channels explore their views"
      />

      <Marquee className="max-w-5xl mx-auto mt-11" gradient={false} speed={25}>
